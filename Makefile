...
_OBJ = main.o Fuse_Core.o Lexer.o Parser.o Operations.o ast/Base.o ast/Literals.o ast/Block.o ast/FuncDef.o ast/Object.o ast/Variable.o ast/BinaryExpr.o ast/Assign.o \
data/Fuse_Object.o data/Fuse_Table.o data/Fuse_Number.o data/Fuse_String.o data/Fuse_Bool.o data/Fuse_Function.o
